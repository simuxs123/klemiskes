...
<div class="selectbar">
  ...
  <div class="aukstai">
    ...
    <a href="/1/3"><li class="active">3a.</li></a>
    </ul>
  </div>
</div>
<div id="daugiabuciai123">
  <div id="mainsection">
    <div id="asd" class="klase">
      ...
      <a href="/1/3/1"><path style="fill:transparent;opacity:0.4" d="{{$pirmasc->cords}}" id="pirmasc1" ></path></a>
            <a href="/1/3/2"><path style="fill:transparent;opacity:0.4" d="{{$pirmasc->cords}}" id="pirmasc2" ></path></a>
            <a href="/1/3/3"><path style="fill:transparent;opacity:0.4" d="{{$pirmasc->cords}}" id="pirmasc3" ></path></a>
...
<div  id="pc1" style="display: none" >
  ...
  <div class="popup">
    <ul>
      ...
      <li id="pirmostatusas">{{$pc[0]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$pc[0]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$pc[0]->kambariai}}</li>
    </ul>
  </div>
</div>
...
<div  id="pc2" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="antrostatusas">{{$pc[1]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$pc[1]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$pc[1]->kambariai}}</li>
    </ul>
  </div>
</div>
...
<div  id="pc3" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;"">Statusas:</li>
      <li id="treciostatusas">{{$pc[2]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$pc[2]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$pc[2]->kambariai}}</li>
    </ul>
  </div>
</div>
