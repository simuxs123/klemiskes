...
<div class="selectbar">
  ...
  <div class="aukstai">
    <h3>Aukštai:</h3>
    <ul>
    <a href="/1/1"><li class="active">1a.</li></a>
...
<div id="daugiabuciai123">
  <div id="mainsection">
    <div id="asd" class="klase">
      ...
      <image height="768" width="100%" id="mainpic" xlink:href="{{asset('images/Daugiabutis1a.jpg')}}"  />
     <a href="/1/1/1"> <path style="fill:transparent;opacity:0.4" d="{{$pirmasa->cords}}" id="pirmasa1" ></path></a>
            <a href="/1/1/2"><path style="fill:transparent;opacity:0.4" d="{{$pirmasa->cords}}" id="pirmasa2" ></path></a>
            <a href="/1/1/3"><path style="fill:transparent;opacity:0.4" d="{{$pirmasa->cords}}" id="pirmasa3" ></path></a>
       </svg>
   </div>
  </div>
</div>

<div  id="pa1" style="display: none" >

  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="pirmostatusas">{{$pa[0]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$pa[0]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$pa[0]->kambariai}}</li>
    </ul>
  </div>
</div>

<div  id="pa2" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="antrostatusas">{{$pa[1]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$pa[1]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$pa[1]->kambariai}}</li>
    </ul>
  </div>
</div>

<div  id="pa3" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;"">Statusas:</li>
      <li id="treciostatusas">{{$pa[2]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$pa[2]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$pa[2]->kambariai}}</li>
    </ul>
  </div>
</div>
