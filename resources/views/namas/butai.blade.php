...
<div class="selectbar text-center">
  <div class="selectbar-box">
    <div class="box-item">
      <h3>Namai:</h3>
      <ul>
      <a href="/pirmasd"><li class="text-capitalize {{ $butai[0]->namo_id==1 ? 'active' : '' }}">namas nr.1</li></a>
      <a href="/antrasd"><li class="text-capitalize {{ $butai[0]->namo_id==2 ? 'active' : '' }}">namas nr.2</li></a>
      <a href="/treciasd"><li class="text-capitalize {{ $butai[0]->namo_id==3 ? 'active' : '' }}">namas nr.3</li></a>
      <a href="/ketvirtasd"><li class="text-capitalize {{ $butai[0]->namo_id==4 ? 'active' : '' }}">namas nr.4</li></a>
      </ul>
    </div>
    <div class="box-item">
      <h3>Aukštai:</h3>
      <ul>
      <a href="/namas/{{$butai[0]->namo_id}}/1"><li class="{{ $butai[0]->auksto_id==1 ? 'active' : '' }}">1a.</li></a>
      <a href="/namas/{{$butai[1]->namo_id}}/2"><li class="{{ $butai[0]->auksto_id==2 ? 'active' : '' }}">2a.</li></a>
      <a href="/namas/{{$butai[2]->namo_id}}/3"><li class="{{ $butai[0]->auksto_id==3 ? 'active' : '' }}">3a.</li></a>
      </ul>
    </div>
  </div>
</div>
  ...
  <div id="mainsection">
    <div id="asd" class="klase">
      <svg viewBox="0 0 1360 768" class="select-svg-main mobile-none svg-defection" xml:space="preserve" version="1.1" height="100" width="100" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd">
        <image height="768" width="100%" id="mainpic" xlink:href="{{$butai[0]->auksto_id==1?asset('images/Daugiabutis1a.jpg'):asset('images\Daugiabutis23a.jpg')}}"  />
        <a href="/namas/{{$butai[0]->namo_id}}/{{$butai[0]->auksto_id}}/{{$butai[0]->buto_id}}"> <path style="fill:transparent;opacity:0.4" d="{{$butai[0]->cords}}" id="{{$klase.$butai[0]->buto_id}}" class="butoMouseover"></path></a>
        <a href="/namas/{{$butai[1]->namo_id}}/{{$butai[1]->auksto_id}}/{{$butai[1]->buto_id}}"><path style="fill:transparent;opacity:0.4" d="{{$butai[1]->cords}}" id="{{$klase.$butai[1]->buto_id}}" class="butoMouseover"></path></a>
        <a href="/namas/{{$butai[2]->namo_id}}/{{$butai[2]->auksto_id}}/{{$butai[2]->buto_id}}"><path style="fill:transparent;opacity:0.4" d="{{$butai[2]->cords}}" id="{{$klase.$butai[2]->buto_id}}" class="butoMouseover"></path></a>
       </svg>
{{--      <input type="hidden" name="homeId" id="homeId" value="{{$butai[0]->namo_id}}">--}}
   </div>
  </div>
</div>

<div class="butoPopup"  id="{{$popUp.'1'}}" style="display: none" >

  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="pirmostatusas">{{$butai[0]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$butai[0]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$butai[0]->kambariai}}</li>
    </ul>
  </div>
</div>

<div class="butoPopup" id="{{$popUp.'2'}}" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="antrostatusas">{{$butai[1]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$butai[1]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$butai[1]->kambariai}}</li>
    </ul>
  </div>
</div>

<div class="butoPopup" id="{{$popUp.'3'}}" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="treciostatusas">{{$butai[2]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$butai[2]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$butai[2]->kambariai}}</li>
    </ul>
  </div>
</div>
