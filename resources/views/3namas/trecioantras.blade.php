...
<div class="selectbar">
  ...
  <div class="aukstai">
    ...
    <a href="/3/2"><li class="active">2a.</li></a>
...
<div id="daugiabuciai123">
  <div id="mainsection">
    <div id="asd" class="klase">
      ...
      <a href="/3/2/1"><path style="fill:transparent;opacity:0.4" d="{{$treciasb->cords}}" id="treciasb1" ></path></a>
            <a href="/3/2/2"><path style="fill:transparent;opacity:0.4" d="{{$treciasb->cords}}" id="treciasb2" ></path></a>
            <a href="/3/2/3"><path style="fill:transparent;opacity:0.4" d="{{$treciasb->cords}}" id="treciasb3" ></path></a>
       </svg>
   </div>
  </div>
</div>
...
<div  id="tb1" style="display: none" >
  ...
  <div class="popup">
    <ul>
      ...
      <li id="pirmostatusas">{{$tb[0]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$tb[0]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$tb[0]->kambariai}}</li>
...
<div  id="tb2" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="antrostatusas">{{$tb[1]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$tb[1]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$tb[1]->kambariai}}</li>
    </ul>
  </div>
</div>
...
<div  id="tb3" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;"">Statusas:</li>
      <li id="treciostatusas">{{$tb[2]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$tb[2]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$tb[2]->kambariai}}</li>
    </ul>
  </div>
</div>
