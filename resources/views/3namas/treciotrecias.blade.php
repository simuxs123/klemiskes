...
<div class="selectbar">
  ...
  <div class="aukstai">
    ...
    <a href="/3/3"><li class="active">3a.</li></a>
    </ul>
  </div>
</div>
<div id="daugiabuciai123">
  <div id="mainsection">
    <div id="asd" class="klase">
      ...
      <a href="/3/3/1"><path style="fill:transparent;opacity:0.4" d="{{$treciasc->cords}}" id="treciasc1" ></path></a>
            <a href="/3/3/2"><path style="fill:transparent;opacity:0.4" d="{{$treciasc->cords}}" id="treciasc2" ></path></a>
            <a href="/3/3/3"><path style="fill:transparent;opacity:0.4" d="{{$treciasc->cords}}" id="treciasc3" ></path></a>
       </svg>
   </div>
  </div>
</div>
...
<div  id="tc1" style="display: none" >
  ...
  <div class="popup">
    <ul>
      ...
      <li id="pirmostatusas">{{$tc[0]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$tc[0]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$tc[0]->kambariai}}</li>
    </ul>
  </div>
</div>
...
<div  id="tc2" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="antrostatusas">{{$tc[1]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$tc[1]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$tc[1]->kambariai}}</li>
    </ul>
  </div>
</div>
...
<div  id="tc3" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;"">Statusas:</li>
      <li id="treciostatusas">{{$tc[2]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$tc[2]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$tc[2]->kambariai}}</li>
    </ul>
  </div>
</div>
