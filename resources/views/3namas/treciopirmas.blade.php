...
<div class="selectbar">
  ...
  <div class="aukstai">
    <h3>Aukštai:</h3>
    <ul>
    <a href="/3/1"><li class="active">1a.</li></a>
...
<div id="daugiabuciai123">
  <div id="mainsection">
    <div id="asd" class="klase">
      ...
      <a href="/3/1/1"><path style="fill:transparent;opacity:0.4" d="{{$treciasa->cords}}" id="treciasa1" ></path></a>
            <a href="/3/1/2"><path style="fill:transparent;opacity:0.4" d="{{$treciasa->cords}}" id="treciasa2" ></path></a>
            <a href="/3/1/3"><path style="fill:transparent;opacity:0.4" d="{{$treciasa->cords}}" id="treciasa3" ></path></a>
       </svg>
   </div>
  </div>
</div>
...
<div  id="ta1" style="display: none" >
  ...
  <div class="popup">
    <ul>
      ...
      <li id="pirmostatusas">{{$ta[0]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$ta[0]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$ta[0]->kambariai}}</li>
    </ul>
  </div>
</div>
...
<div  id="ta2" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="antrostatusas">{{$ta[1]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$ta[1]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$ta[1]->kambariai}}</li>
...
<div  id="ta3" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;"">Statusas:</li>
      <li id="treciostatusas">{{$ta[2]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$ta[2]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$ta[2]->kambariai}}</li>
