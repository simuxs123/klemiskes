...
<div class="selectbar">
  ...
  <div class="aukstai">
    ...
    <a href="/4/3"><li class="active">3a.</li></a>
    </ul>
  </div>
</div>
<div id="daugiabuciai123">
  <div id="mainsection">
    <div id="asd" class="klase">
      ...
      <a href="/4/3/1"><path style="fill:transparent;opacity:0.4" d="{{$ketvirtasc->cords}}" id="ketvirtasc1" ></path></a>
           <a href="/4/3/2"> <path style="fill:transparent;opacity:0.4" d="{{$ketvirtasc->cords}}" id="ketvirtasc2" ></path></a>
           <a href="/4/3/3"> <path style="fill:transparent;opacity:0.4" d="{{$ketvirtasc->cords}}" id="ketvirtasc3" ></path></a>
       </svg>
   </div>
  </div>
</div>

<div  id="kc1" style="display: none" >

  <div class="popup">
    <ul>
      <li style="color: black;"" >Statusas:</li>
      <li id="pirmostatusas">{{$kc[0]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$kc[0]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$kc[0]->kambariai}}</li>
    </ul>
  </div>
</div>

<div  id="kc2" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="antrostatusas">{{$kc[1]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$kc[1]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$kc[1]->kambariai}}</li>    </ul>
  </div>
</div>

<div  id="kc3" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;"">Statusas:</li>
      <li id="treciostatusas">{{$kc[2]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$kc[2]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$kc[2]->kambariai}}</li>
    </ul>
  </div>
</div>
