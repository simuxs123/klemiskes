...
<div class="selectbar">
  ...
  <div class="aukstai">
    ...
    <a href="/4/2"><li class="active">2a.</li></a>
...
<div id="daugiabuciai123">
  <div id="mainsection">
    <div id="asd" class="klase">
      ...
      <a href="/4/2/1"><path style="fill:transparent;opacity:0.4" d="{{$ketvirtasb->cords}}" id="ketvirtasb1" ></path></a>
            <a href="/4/2/2"><path style="fill:transparent;opacity:0.4" d="{{$ketvirtasb->cords}}" id="ketvirtasb2" ></path></a>
            <a href="/4/2/2"><path style="fill:transparent;opacity:0.4" d="{{$ketvirtasb->cords}}" id="ketvirtasb3" ></path></a>
       </svg>
   </div>
  </div>
</div>

<div  id="kb1" style="display: none" >

  <div class="popup">
    <ul>
      <li style="color: black;"" >Statusas:</li>
      <li id="pirmostatusas">{{$kb[0]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$kb[0]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$kb[0]->kambariai}}</li>
    </ul>
  </div>
</div>

<div  id="kb2" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="antrostatusas">{{$kb[1]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$kb[1]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$kb[1]->kambariai}}</li>
    </ul>
  </div>
</div>

<div  id="kb3" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;"">Statusas:</li>
      <li id="treciostatusas">{{$kb[2]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$kb[2]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$kb[2]->kambariai}}</li>
    </ul>
  </div>
</div>
