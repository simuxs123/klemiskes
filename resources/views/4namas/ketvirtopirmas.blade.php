...
<div class="selectbar">
  ...
  <div class="aukstai">
    <h3>Aukštai:</h3>
    <ul>
    <a href="/4/1"><li class="active">1a.</li></a>
...
<div id="daugiabuciai123">
  <div id="mainsection">
    <div id="asd" class="klase">
      ...
      <a href="/4/1/1"><path style="fill:transparent;opacity:0.4" d="{{$ketvirtasa->cords}}" id="ketvirtasa1" ></path></a>
            <a href="/4/1/2"><path style="fill:transparent;opacity:0.4" d="{{$ketvirtasa->cords}}" id="ketvirtasa2" ></path></a>
            <a href="/4/1/3"><path style="fill:transparent;opacity:0.4" d="{{$ketvirtasa->cords}}" id="ketvirtasa3" ></path></a>
       </svg>
   </div>
  </div>
</div>
...
<div  id="ka1" style="display: none" >
  ...
  <div class="popup">
    <ul>
      ...
      <li id="pirmostatusas">{{$ka[0]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$ka[0]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$ka[0]->kambariai}}</li>
    </ul>
  </div>
</div>

<div  id="ka2" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="antrostatusas">{{$ka[1]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$ka[1]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$ka[1]->kambariai}}</li>
    </ul>
  </div>
</div>
...
<div  id="ka3" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;"">Statusas:</li>
      <li id="treciostatusas">{{$ka[2]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$ka[2]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$ka[2]->kambariai}}</li>
    </ul>
  </div>
</div>
