...
<div class="selectbar">
  ...
  <div class="aukstai">
    ...
    <a href="/2/3"><li class="active">3a.</li></a>
    </ul>
  </div>
</div>
<div id="daugiabuciai123">
  <div id="mainsection">
    <div id="asd" class="klase">
      ...
      <a href="/2/3/1"><path style="fill:transparent;opacity:0.4" d="{{$antrasc->cords}}" id="antrasc1" ></path></a>
            <a href="/2/3/2"><path style="fill:transparent;opacity:0.4" d="{{$antrasc->cords}}" id="antrasc2" ></path></a>
            <a href="/2/3/3"><path style="fill:transparent;opacity:0.4" d="{{$antrasc->cords}}" id="antrasc3" ></path></a>
       </svg>
   </div>
  </div>
</div>

<div  id="ac1" style="display: none" >

  <div class="popup">
    <ul>
      <li style="color: black;"" >Statusas:</li>
      <li id="pirmostatusas">{{$ac[0]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$ac[0]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$ac[0]->kambariai}}</li>
    </ul>
  </div>
</div>

<div  id="ac2" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="antrostatusas">{{$ac[1]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$ac[1]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$ac[1]->kambariai}}</li>
    </ul>
  </div>
</div>
...
<div  id="ac3" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;"">Statusas:</li>
      <li id="treciostatusas">{{$ac[2]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$ac[2]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$ac[2]->kambariai}}</li>
    </ul>
  </div>
</div>
