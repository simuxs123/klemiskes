...
<div class="selectbar">
  ...
  <div class="aukstai">
    <h3>Aukštai:</h3>
    <ul>
    <a href="/2/1"><li class="active">1a.</li></a>
...
<div id="daugiabuciai123">
  <div id="mainsection">
    <div id="asd" class="klase">
      ...
      <a href="/2/1/1"><path style="fill:transparent;opacity:0.4" d="{{$antrasa->cords}}" id="antrasa1" ></path></a>
            <a href="/2/1/2"><path style="fill:transparent;opacity:0.4" d="{{$antrasa->cords}}" id="antrasa2" ></path></a>
            <a href="/2/1/3"><path style="fill:transparent;opacity:0.4" d="{{$antrasa->cords}}" id="antrasa3" ></path></a>
       </svg>
   </div>
  </div>
</div>
...
<div  id="aa1" style="display: none" >
  ...
  <div class="popup">
    <ul>
      ...
      <li id="pirmostatusas">{{$aa[0]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$aa[0]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$aa[0]->kambariai}}</li>
    </ul>
  </div>
</div>
...
<div  id="aa2" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="antrostatusas">{{$aa[1]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$aa[1]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$aa[1]->kambariai}}</li>
    </ul>
  </div>
</div>
...
<div  id="aa3" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;"">Statusas:</li>
      <li id="treciostatusas">{{$aa[2]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$aa[2]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$aa[2]->kambariai}}</li>
    </ul>
  </div>
</div>
