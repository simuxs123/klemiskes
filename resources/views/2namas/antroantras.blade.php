...
<div class="selectbar">
  ...
  <div class="aukstai">
    ...
    <a href="/2/2"><li class="active">2a.</li></a>
...
<div id="daugiabuciai123">
  <div id="mainsection">
    <div id="asd" class="klase">
      ...
      <a href="/2/2/1"><path style="fill:transparent;opacity:0.4" d="{{$antrasb->cords}}" id="antrasb1" ></path></a>
            <a href="/2/2/2"><path style="fill:transparent;opacity:0.4" d="{{$antrasb->cords}}" id="antrasb2" ></path></a>
            <a href="/2/2/3"><path style="fill:transparent;opacity:0.4" d="{{$antrasb->cords}}" id="antrasb3" ></path></a>
       </svg>
   </div>
  </div>
</div>
...
<div  id="ab1" style="display: none" >
  ...
  <div class="popup">
    <ul>
      ...
      <li id="pirmostatusas">{{$ab[0]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$ab[0]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$ab[0]->kambariai}}</li>
    </ul>
  </div>
</div>
...
<div  id="ab2" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;">Statusas:</li>
      <li id="antrostatusas">{{$ab[1]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$ab[1]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$ab[1]->kambariai}}</li>
    </ul>
  </div>
</div>
...
<div  id="ab3" style="display: none;">
  <div class="popup">
    <ul>
      <li style="color: black;"">Statusas:</li>
      <li id="treciostatusas">{{$ab[2]->statusas}}</li>
      <li style="color: black;" >Plotas kv.m: {{$ab[2]->plotas}}</li>
      <li style="color: black;">Kambarių sk.: {{$ab[2]->kambariai}}</li>
    </ul>
  </div>
</div>
