<header>
	<div class="navbar navbar-default ">
      <div id="visasnav" class="nav-container">
        <div class="navheader">
          <a href="/"><img id="headerlogo" src="{{ asset('/images/logo.png') }}"></a>
          <button id="belekas" class="navbar-toggle" type="button" data-toggle="collapse" data-target="#navbar-main">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">
           <li id="headerapieprojekta"><p>|</p><img id="apiestogelis" class="stogelis" src="{{asset('images\stogelis.png')}}"><a href="/apieprojekta" id="aapie" >Apie projektą</a></li>
